...
function animate() {
    ...
    for (let i = powerUps.length - 1; 0 <= i; i--) {
      ...
      powerUp.draw();
       ...
       // Người chơi đụng vào điểm để mạnh lên
       if (Math.hypot(
        ...
        // Con ma sẽ sợ hãi và đổi màu xanh
